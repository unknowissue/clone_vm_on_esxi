...
def clone_vm_from_template(vm_name, template_name, esxi_host, template_vmx, template_vmdks, base_destination_path):
    ...
    for template_vmdk in template_vmdks:
        ...
        playbook_command = f"ansible-playbook clone_vm_disk.yml -e 'esxi_host={esxi_host}  template_vmdk_path={template_vmdk_path} destination_path={destination_path} vm_path={vm_path}' "
